...
gitsigns.setup({
   ...
   signs = {
      ...
      delete = { hl = "GitSignsDelete", text = "ﮁ_", numhl = "GitSignsDeleteNr", linehl = "GitSignsDeleteLn" },
      topdelete = { hl = "GitSignsDelete", text = "ﮁ‾", numhl = "GitSignsDeleteNr", linehl = "GitSignsDeleteLn" },
      changedelete = { hl = "GitSignsChange", text = "ﮁ~", numhl = "GitSignsChangeNr", linehl = "GitSignsChangeLn" },
   },
   -- 显示图标
